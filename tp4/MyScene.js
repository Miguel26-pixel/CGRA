...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.unitcube = new MyUnitCubeQuad(this,'images/mineTop.png','images/mineSide.png', 'images/mineSide.png', 'images/mineSide.png', 'images/mineSide.png', 'images/mineBottom.png');
        ...
        this.faceTangram = new CGFappearance(this);
        this.faceTangram.setAmbient(0.1, 0.1, 0.1, 1);
        this.faceTangram.setDiffuse(0.9, 0.9, 0.9, 1);
        this.faceTangram.setSpecular(0.1, 0.1, 0.1, 1);
        this.faceTangram.setShininess(10.0);
        this.faceTangram.loadTexture('images/tangram.png');
        this.faceTangram.setTextureWrap('REPEAT', 'REPEAT');
        //------
    ...
    updateAppliedTexture() {
        ...
        this.faceTangram.setTexture(this.textures[this.selectedTexture]);
    }
    ...
    updateTextureWrapping() {
        ...
        this.faceTangram.setTextureWrap(this.wrappingMethods[this.wrapS], this.wrappingMethods[this.wrapT]);
    }
